...
mw_photon_model     Model for the Milky Way photon distribution
mw_mag_model       Model for the magnetic field
"""
...
galaxy_model = 'Schober' #Redshift evolution of galaxies model
flux_model = 'Nieder'   #neutrino flux model
mw_photon_model = 'Schober' #Milky Way photon distribution model
mw_mag_model = 'JF'        #Magnetic field model. Either Jansson & Farrar (JF) or Pshirkov (Pshirkov).
